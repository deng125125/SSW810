...
class Student:
    ...
    def __init__(self, cwid, directory):
        ...
        self.remaining_electives = remaining_courses(electives, self.courses)
...
def main():
    ...
    pretty_print(path + "\\HW10")
    # pretty_print("D:\\2019_Fall_Stevens\\ssw810\\homework\\HW10")
    """
    rep = Repository("D:\\2019_Fall_Stevens\\ssw810\\homework\\HW10")
